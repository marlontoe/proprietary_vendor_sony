...
PRODUCT_COPY_FILES += \
    ...
    $(COMMON_PATH)/proprietary/system/lib/egl/libGLESv2_adreno.so:system/lib/egl/libGLESv2_adreno200.so \
    $(COMMON_PATH)/proprietary/system/lib/egl/eglsubAndroid.so:system/lib/egl/eglsubAndroid.so \
    $(COMMON_PATH)/proprietary/system/lib/egl/libGLESv2S3D_adreno.so:system/lib/egl/libGLESv2S3D_adreno200.so \
    $(COMMON_PATH)/proprietary/system/lib/egl/libq3dtools_adreno.so:system/lib/egl/libq3dtools_adreno200.so \
    $(COMMON_PATH)/proprietary/system/lib/egl/libEGL_adreno.so:system/lib/egl/libEGL_adreno200.so \
    $(COMMON_PATH)/proprietary/system/lib/egl/libGLESv1_CM_adreno.so:system/lib/egl/libGLESv1_CM_adreno200.so \
    $(COMMON_PATH)/proprietary/system/lib/libadreno_utils.so:system/lib/libadreno_utils.so \
